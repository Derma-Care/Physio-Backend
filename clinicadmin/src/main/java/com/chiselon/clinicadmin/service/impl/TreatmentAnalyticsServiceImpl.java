...
import com.chiselon.clinicadmin.dto.Session;
import com.chiselon.clinicadmin.dto.physioresponse.ExerciseResponse;
import com.chiselon.clinicadmin.dto.physioresponse.PackageResponse;
import com.chiselon.clinicadmin.dto.physioresponse.PaymentRecordResponse;
import com.chiselon.clinicadmin.dto.physioresponse.ProgramResponse;
import com.chiselon.clinicadmin.dto.physioresponse.TherapyResponse;
import com.chiselon.clinicadmin.dto.physioresponse.TreatmentAnalyticsResponse;
import com.chiselon.clinicadmin.dto.physioresponse.TreatmentRow;
import com.chiselon.clinicadmin.feignclient.PhysiotherapyFeignClient;
import com.chiselon.clinicadmin.service.TreatmentAnalyticsService;
...
log.info("getAnalytics method invoked with inputs clinicId:{},branchId:{},type:{},dateFilter:{}",
	...
	private List<PaymentRecordResponse> fetchPaymentRecords(String clinicId, String branchId) {
		try {
			Response response = physiotherapyDoctorFeign.getPayments(keyCloakTokenStore.getAccess_token(),clinicId, branchId);
