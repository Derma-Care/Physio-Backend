...
import com.chiselon.clinicadmin.dto.ServiceInfo;
import com.chiselon.clinicadmin.dto.TherapistDTO;
import com.chiselon.clinicadmin.dto.TherapistFeedbackResponseDTO;
import com.chiselon.clinicadmin.dto.TherapistFeedbackSummaryDTO;
...
import com.chiselon.clinicadmin.entity.Session;
import com.chiselon.clinicadmin.entity.Therapist;
...
import com.chiselon.clinicadmin.repository.TherapistRecordRepository;
...
import com.chiselon.clinicadmin.service.TherapistService;
...
log.error("{}",e.getMessage());
    ...
    @RateLimiter(
            ...
            fallbackMethod = "getTherapistFeedbackFallback")
...
log.error("{}",e.getMessage());
    ...
    @RateLimiter(
            name = "therapistService",
            fallbackMethod = "getTherapistsWithServicesFallback")
    ...
    /**
     * Fallback for getTherapistFeedback
     */
    public Response getTherapistFeedbackFallback(
            String clinicId,
            String branchId,
            String therapistId,
            Exception ex) {
        ...
        response.setMessage(
                "Rate limit exceeded while fetching therapist feedback. Please try again later.");
        response.setData(null);
    ...
    /**
     * Fallback for getTherapistsWithServices
     */
    public Response getTherapistsWithServicesFallback(
            String clinicId,
            String branchId,
            Exception ex) {
        ...
        response.setStatus(HttpStatus.TOO_MANY_REQUESTS.value());
        response.setMessage(
                "Rate limit exceeded while fetching therapists. Please try again later.");
