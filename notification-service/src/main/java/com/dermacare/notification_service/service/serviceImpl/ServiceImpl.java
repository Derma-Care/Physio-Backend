...
//			notificationEntity.setMessage("New Service Appointment Request For: " + booking.getSubServiceName());
	...
	public ResBody<List<NotificationDTO>> sendNotificationToClinic(String clinicId) {
	 ...
	 @RateLimiter(name = "notificationService", fallbackMethod = "notificationResponseFallback")
...
//	
	 ...
	 @RateLimiter(name = "notificationService", fallbackMethod = "priceDropNotificationsFallback")
	 ...
	 @RateLimiter(name = "notificationService", fallbackMethod = "deletePriceDropAlertsFallback")	 	 
