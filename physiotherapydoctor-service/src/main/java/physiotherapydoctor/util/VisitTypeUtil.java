...
public class VisitTypeUtil {
	...
	private static final String[] SMALL = { "", "FIRST", "SECOND", "THIRD", "FOURTH", "FIFTH", "SIXTH", "SEVENTH",
			"EIGHTH", "NINTH", "TENTH", "ELEVENTH", "TWELFTH", "THIRTEENTH", "FOURTEENTH", "FIFTEENTH", "SIXTEENTH",
			"SEVENTEENTH", "EIGHTEENTH", "NINETEENTH" };
	private static final String[] TENS = { "", "", "TWENTIETH", "THIRTIETH", "FORTIETH", "FIFTIETH", "SIXTIETH",
